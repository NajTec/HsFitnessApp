...
{
    public partial class FitnessDBWestContext : DbContext
    {
        public FitnessDBWestContext()
        {
        }

        public FitnessDBWestContext(DbContextOptions<FitnessDBWestContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<FoodData>(entity =>
            {
                entity.HasKey(e => e.Name)
                    .HasName("PK__FoodData__737584F7DFFF0A8B");
            ...
            modelBuilder.Entity<RefreshToken>(entity =>
            {
                ...
                entity.HasOne(d => d.AliasNavigation)
                    ...
                    .HasConstraintName("FK__RefreshTo__Alias__05D8E0BE");
            });

            modelBuilder.Entity<SportData>(entity =>
            {
                entity.HasKey(e => e.Name)
                    .HasName("PK__SportDat__737584F787699A0B");
            ...
            modelBuilder.Entity<UserData>(entity =>
            {
                entity.HasKey(e => e.Alias)
                    .HasName("PK__UserData__70F4A9E17292E0CC");
            ...
            modelBuilder.Entity<UserFood>(entity =>
            {
                entity.HasKey(e => new { e.FoodName, e.UserAlias })
                    .HasName("PK__UserFood__9010C56BB6ED334A");
            ...
            modelBuilder.Entity<UserSportTotal>(entity =>
            {
                entity.HasKey(e => e.UserAlias)
                    .HasName("PK__UserSpor__1A4394F05C36A453");
